...
#  Location of the compiled Rust app and external libraries.  Each app and library will be compiled in a *.rlib archive here.
...
#  Delete the compiled ROM image so that the build script will relink the Rust app with Mynewt OS.
if [ -e $app_build ]; then
    rm $app_build
fi
