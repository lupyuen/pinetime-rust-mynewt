...
# 1 "repos/apache-mynewt-core/kernel/os/src/os.c"
# 20 "repos/apache-mynewt-core/kernel/os/src/os.c"
...
# 21 "repos/apache-mynewt-core/kernel/os/src/os_priv.h"
#define H_OS_PRIV_ 
...
# 28 "repos/apache-mynewt-core/hw/hal/include/hal/hal_os_tick.h"
#define H_HAL_OS_TICK_ 
# 43 "repos/apache-mynewt-core/hw/hal/include/hal/hal_os_tick.h"
...
# 29 "repos/apache-mynewt-core/hw/hal/include/hal/hal_system.h"
#define H_HAL_SYSTEM_ 
# 38 "repos/apache-mynewt-core/hw/hal/include/hal/hal_system.h"
...
# 29 "repos/apache-mynewt-core/hw/hal/include/hal/hal_watchdog.h"
#define _HAL_WATCHDOG_H_ 
# 47 "repos/apache-mynewt-core/hw/hal/include/hal/hal_watchdog.h"
...
# 43 "repos/apache-mynewt-core/kernel/os/src/os.c"
...
static os_stack_t os_main_stack [(( (((((1024))) & (((8)) - 1)) == 0) ? (((1024))) : ((((1024))) + (((8)) - ((((1024))) & (((8)) - 1)))) ))] __attribute__((aligned((8))));;
# 73 "repos/apache-mynewt-core/kernel/os/src/os.c"
int g_os_started;
...
# 86 "repos/apache-mynewt-core/kernel/os/src/os.c"
void
os_idle_task(void *arg)
{
    ...
    sanity_itvl_ticks = ((15000) * (1000)) / 1000;
    sanity_last = 0;
    ...
    while (1) {
        ...
        if (iticks < ((100) * (1000) / 1000)) {
            iticks = 0;
        } else if (iticks > ((600000) * (1000) / 1000)) {
            iticks = ((600000) * (1000) / 1000);
        } else {
...
os_main(void *arg)
{
    ...
    fn(0, 
# 163 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
         ((void *)0)
# 163 "repos/apache-mynewt-core/kernel/os/src/os.c"
             );
...
# 170 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 170 "repos/apache-mynewt-core/kernel/os/src/os.c"
   , 0, 
# 170 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 170 "repos/apache-mynewt-core/kernel/os/src/os.c"
...
# 186 "repos/apache-mynewt-core/kernel/os/src/os.c"
void
...
# 191 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
                                                         ((void *)0)
# 191 "repos/apache-mynewt-core/kernel/os/src/os.c"
                                                             ,
            (0xff), (-1), g_idle_task_stack,
            (( (((((64))) & (((8)) - 1)) == 0) ? (((64))) : ((((64))) + (((8)) - ((((64))) & (((8)) - 1)))) )));
    ((rc == 0) ? (void)0 : __assert_func(
# 194 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 194 "repos/apache-mynewt-core/kernel/os/src/os.c"
   , 0, 
# 194 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 194 "repos/apache-mynewt-core/kernel/os/src/os.c"
...
# 194 "repos/apache-mynewt-core/kernel/os/src/os.c"
    ...
    rc = os_sanity_init();
    ((rc == 0) ? (void)0 : __assert_func(
# 198 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 198 "repos/apache-mynewt-core/kernel/os/src/os.c"
   , 0, 
# 198 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 198 "repos/apache-mynewt-core/kernel/os/src/os.c"
...
# 198 "repos/apache-mynewt-core/kernel/os/src/os.c"
    ...
    ((rc == 0) ? (void)0 : __assert_func(
# 201 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 201 "repos/apache-mynewt-core/kernel/os/src/os.c"
   , 0, 
# 201 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 201 "repos/apache-mynewt-core/kernel/os/src/os.c"
...
# 219 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 219 "repos/apache-mynewt-core/kernel/os/src/os.c"
   ; (&g_callout_list)->tqh_last = &(((&g_callout_list))->tqh_first); } while (0);
    do { (((&g_os_task_list))->stqh_first) = 
# 220 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 220 "repos/apache-mynewt-core/kernel/os/src/os.c"
...
# 227 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 227 "repos/apache-mynewt-core/kernel/os/src/os.c"
   , 0, 
# 227 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 227 "repos/apache-mynewt-core/kernel/os/src/os.c"
...
# 227 "repos/apache-mynewt-core/kernel/os/src/os.c"
    ...
    if (main_fn) {
        err = os_task_init(&os_main_task, "main", os_main, main_fn,
                           (127), (-1), os_main_stack,
                           (( (((((1024))) & (((8)) - 1)) == 0) ? (((1024))) : ((((1024))) + (((8)) - ((((1024))) & (((8)) - 1)))) )));
...
# 233 "repos/apache-mynewt-core/kernel/os/src/os.c"
    ...
    ((err == OS_OK) ? (void)0 : __assert_func(
# 239 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 239 "repos/apache-mynewt-core/kernel/os/src/os.c"
   , 0, 
# 239 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 239 "repos/apache-mynewt-core/kernel/os/src/os.c"
...
# 239 "repos/apache-mynewt-core/kernel/os/src/os.c"
    ...
    ((err == OS_OK) ? (void)0 : __assert_func(
# 242 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 242 "repos/apache-mynewt-core/kernel/os/src/os.c"
   , 0, 
# 242 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 242 "repos/apache-mynewt-core/kernel/os/src/os.c"
...
os_start(void)
{
    ...
    ((err == OS_OK) ? (void)0 : __assert_func(
# 255 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 255 "repos/apache-mynewt-core/kernel/os/src/os.c"
   , 0, 
# 255 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 255 "repos/apache-mynewt-core/kernel/os/src/os.c"
...
# 284 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 284 "repos/apache-mynewt-core/kernel/os/src/os.c"
   , 0, 
# 284 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 284 "repos/apache-mynewt-core/kernel/os/src/os.c"
...
# 284 "repos/apache-mynewt-core/kernel/os/src/os.c"
    ...
    ((err == OS_OK) ? (void)0 : __assert_func(
# 287 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 287 "repos/apache-mynewt-core/kernel/os/src/os.c"
   , 0, 
# 287 "repos/apache-mynewt-core/kernel/os/src/os.c" 3 4
   ((void *)0)
# 287 "repos/apache-mynewt-core/kernel/os/src/os.c"
