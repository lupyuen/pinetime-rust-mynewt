...
pub mod encoding {
    ...
    pub mod macros {
        ...
        macro_rules! coap_item_int((
                                   ...
                                   $ array0 , "key" , $ key0 ) ; $ crate ::
                                   json_rep_set_int ! (
                                   $ array0 , "value" , $ value0 ) ; unsafe {
                                   $ array0 . json_set_geolocation (
                                   strn ! ( "geo" ) , strn ! ( "lat" ) , strn
                                   ! ( "long" ) , $ geo0 ) } ; } ) ; d ! (
        ...
        macro_rules! coap_item_int_val((
                                       ...
                                       context , val : $ val0 ) ; let geo = $
                                       val0 . geo ; if let SensorValueType ::
                                       Uint ( val ) = $ val0 . value {
                                       $ crate :: coap_item_int ! (
        ...
        macro_rules! json_rep_set_text_string((
                                              ...
                                              ;);
        #[macro_export]
        macro_rules! oc_rep_start_root_object(( $ obj : ident ) => {
                                              {
                                              d ! (
        ...
        macro_rules! oc_rep_set_int((
                                    $ obj : ident , $ key : ident , $ value :
                                    expr ) => {
                                    concat ! (
                                    "-- cinti" , " c: " , stringify ! ( $ obj
                                    ) , ", k: " , stringify ! ( $ key ) ,
                                    ...
                                    ; } ; (
                                    $ obj : ident , $ key : expr , $ value :
                                    expr ) => {
                                    concat ! (
                                    "-- cinte" , " c: " , stringify ! ( $ obj
                                    ) , ", k: " , stringify ! ( $ key ) ,
                                    ", v: " , stringify ! ( $ value ) ) ; let
                                    key_with_opt_null : & [ u8 ] = $ key .
...
pub mod spi {
    ...
    pub fn spi_noblock_write_command(cmd: u8) -> MynewtResult<()> {
        if unsafe { PENDING_CMD.len() } > 0 { spi_noblock_write_flush()?; }
