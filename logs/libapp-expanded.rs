...
mod visual {
    ...
    static mut WIDGET_STATE_STATE: [WidgetType<State>; MAX_WIDGETS] =
        [WidgetType::None, WidgetType::None, WidgetType::None,
         WidgetType::None, WidgetType::None, WidgetType::None,
         WidgetType::None, WidgetType::None, WidgetType::None,
         WidgetType::None];
    ...
    static mut ALL_HANDLERS_STATE: [DruidHandler<State>; MAX_WINDOWS] =
        [DruidHandler::<State>{window_id: WindowId(0), phantom: PhantomData,},
         DruidHandler::<State>{window_id: WindowId(0), phantom: PhantomData,},
         DruidHandler::<State>{window_id: WindowId(0),
                               phantom: PhantomData,}];
    ...
    pub fn handle_touch(x: u16, y: u16) {
        ...
        handler.mouse_down(&MouseEvent{pos: Point::new(x as f64, y as f64),
                                       count: 1,
                                       button: MouseButton::Left,}, &mut ctx);
        handler.mouse_up(&MouseEvent{pos: Point::new(x as f64, y as f64),
                                     count: 0,
                                     button: MouseButton::Left,}, &mut ctx);
    }
    ...
    impl GlobalWindows<State> for AppState<State> {
        ...
        fn add_handler(&self, window_id: WindowId,
                       handler: DruidHandler<State>) {
            unsafe { ALL_HANDLERS_STATE[window_id.0 as usize] = handler; }
        }
        fn get_handle(&self, window_id: WindowId)
         -> WindowHandle<DruidHandler<State>> {
            let handler =
        ...
        fn window_event(&mut self, window_id: WindowId,
                        ctx: &mut EventCtx<State>, event: &Event) {
            unsafe {
        ...
        fn window_update(&mut self, window_id: WindowId,
        ...
        fn window_layout(&mut self, window_id: WindowId,
        ...
        fn window_paint(&mut self, window_id: WindowId,
...
extern "C" fn main() -> ! {
    ...
    #[cfg(feature = "visual_app")]
    visual::on_start().expect("VIS fail");
    loop  {
