...
use mynewt::{result::*,  // Import Mynewt API Result and Error types
             ...
             Strn, coap, d};
// Import Mynewt macros
use mynewt_macros::{infer_type, init_strn, strn};
// Import Mynewt procedural macros
...
fn on_start() -> MynewtResult<()> {
    ...
    start_sensor_listener(SENSOR_DEVICE, TEMP_SENSOR_KEY, TEMP_SENSOR_TYPE,
                          SENSOR_POLL_TIME)?;
