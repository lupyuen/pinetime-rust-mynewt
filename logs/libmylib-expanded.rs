...
mod mynewt {
    ...
    pub mod macros {
        ...
        macro_rules! parse((
                           ...
                           * ) } ; (
                           ...
                           @ json { $ ( $ tt : tt ) + } ) => {
                           {
                           d ! ( begin json root ) ; let mut values_map :
                           CborEncoder = fill_zero ! ( CborEncoder ) ; let mut
                           values_array : CborEncoder = fill_zero ! (
                           CborEncoder ) ; coap_root ! (
                           @ json {
                           coap_array ! (
                           @ json root , values , {
                           parse ! (
    ...
    pub mod sensor {
        ...
        static mut LISTENER_INTERNAL: SensorListener =
            SensorListener{sl_func:
                               null_sensor_data_func,
                                                        ..unsafe {
                                                              ::core::mem::transmute::<[u8; ::core::mem::size_of::<SensorListener>()],
                                                                                       SensorListener>([0;
                                                                                                           ::core::mem::size_of::<SensorListener>()])
                                                          }};
...
mod listen_sensor {
    ...
    pub fn start_sensor_listener() -> Result<(), i32> {
