input: ItemForeignMod {
    ...
    abi: Abi {
        ...
        name: Some(
            LitStr {
                token: Literal { lit: Str_(C), suffix: None, span: Span { lo: BytePos(304611), hi: BytePos(304614), ctxt: #0 } },
            },
        ),
    },
    brace_token: Brace,
