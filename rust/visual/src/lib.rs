...
//  let sensor, poll_time, sensor_data, millisec, sensor_object, listener, eventq, uri, previous, SENSOR_DEVICE, device_id, SENSOR_POLL_TIME, network_ready, NULL_SENSOR_OBJECT, DEFAULT_URI, payload;
...
fn sensor_network::get_device_id() -> MynewtResult<()> {
  Ok(())
}
...
/// Describe this function...
fn sensor_network::start_server_transport() -> MynewtResult<()> {
  Ok(())
}

/// Describe this function...
fn sensor::mgr_find_next_bydevname(sensor, previous) -> MynewtResult<()> {
  Ok(())
}
...
/// Describe this function...
fn sensor_network::init_server_post(uri) -> MynewtResult<()> {
  Ok(())
}

/// Describe this function...
fn sensor::register_listener(sensor_object, listener) -> MynewtResult<()> {
  Ok(())
}
...
/// Describe this function...
fn sensor_network::do_server_post() -> MynewtResult<()> {
  Ok(())
}
