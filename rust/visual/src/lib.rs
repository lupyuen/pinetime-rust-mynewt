...
//  let sensor, poll_time, sensor_data, millisec, listener, eventq, uri, SENSOR_DEVICE, device_id, SENSOR_POLL_TIME, network_ready, DEFAULT_URI, payload;
