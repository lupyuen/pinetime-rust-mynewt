...
//  let sensor, sensor_type, poll_time, sensor_data, millisec, eventq, previous, uri, sensor_object, listener, func, SENSOR_DEVICE, device_id, SENSOR_POLL_TIME, network_ready, TEMP_SENSOR_KEY, TEMP_SENSOR_TYPE, NULL_SENSOR_OBJECT, DEFAULT_URI, payload, SENSOR_TYPE_AMBIENT_TEMPERATURE_RAW;
...
/// Describe this function...
//  Import sensor::new_sensor_listener
