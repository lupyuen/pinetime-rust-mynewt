...
- `00:00` - PineTime is preloaded with...
    ...
    ST-Link debugger is connected, showing the debug log. Here are the messages generated by MCUBoot during booting, `Swap type` is set to `perm` because we have previously used nRF Connect to mark the Firmware image as "Confirmed"...
