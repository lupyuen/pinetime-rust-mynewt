...
#define GPS_L70R_DEVICE "gps_l70r_0"  //  Name of the GPS_L70R device
...
//  Various timeouts for different GPS_L70R operations, in milliseconds.
...
//  GPS_L70R Configuration: UART and Socket Configuration
struct gps_l70r_cfg {
    //  UART Configuration
    int uart;    
};

//  GPS_L70R Device Instance for Mynewt
struct gps_l70r {
    struct os_dev dev;
