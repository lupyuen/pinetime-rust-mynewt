...
//  Create Stub Temperature sensor
#include "os/mynewt.h"
#include "console/console.h"
#include "sensor/sensor.h"
#include "temp_stub/temp_stub.h"  //  Specific to device

//  Define the device specifics here so the device creation code below can be generic.
#define DEVICE_NAME        MYNEWT_VAL(TEMP_STUB_DEVICE)  //  Name of device
#define DEVICE_DEV         temp_stub              //  Device type
#define DEVICE_INSTANCE    temp_stub_dev          //  Device instance
#define DEVICE_CFG         temp_stub_cfg          //  Device config
#define DEVICE_CFG_DEFAULT temp_stub_default_cfg  //  Device default config
#define DEVICE_CFG_FUNC    temp_stub_config       //  Device config function
#define DEVICE_INIT        temp_stub_init         //  Device init function
#define DEVICE_CREATE      temp_stub_create       //  Device create function
#define DEVICE_ITF         adc_1_itf_temp_stub    //  Device interface
