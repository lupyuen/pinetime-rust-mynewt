...
#ifndef __MCU_GD32VF103_MCU_H_
#define __MCU_GD32VF103_MCU_H_
 ...
 * GPIO pin mapping
 *
 * The gd32vf103 processors have 16 gpio pins per port. The encoding of IO pins
...
/*
 * Defines for naming GPIOs. Based on Firmware/GD32VF103_standard_peripheral/Include/gd32vf103_gpio.h
 */
#define MCU_GPIO_PORTA(pin)	(GPIOA + (pin))
#define MCU_GPIO_PORTB(pin)	(GPIOB + (pin))
#define MCU_GPIO_PORTC(pin)	(GPIOC + (pin))
#define MCU_GPIO_PORTD(pin)	(GPIOD + (pin))
#define MCU_GPIO_PORTE(pin)	(GPIOE + (pin))

/*
 * Helper macros to extract components from a pin descriptor.
 */
#define MCU_GPIO_PIN_NUM(pin)   (0x0000000F &  pin)
#define MCU_GPIO_PIN_PORT(pin)  (0xFFFFFF00 &  pin)
#define MCU_GPIO_PIN_PAD(pin)   (0x000000FF &  pin)
