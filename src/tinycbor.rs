...
pub type __uint8_t = ::core::raw::c_uchar;
pub type __uint16_t = ::core::raw::c_ushort;
pub type __uint32_t = ::core::raw::c_ulong;
pub type __int64_t = ::core::raw::c_longlong;
pub type __uint64_t = ::core::raw::c_ulonglong;
pub type __uintptr_t = ::core::raw::c_uint;
pub type FILE = File;
#[repr(C)]
...
pub struct File_methods {
    pub write: ::core::option::Option<
        unsafe extern "C" fn(
            instance: *mut FILE,
            bp: *const ::core::raw::c_char,
            n: usize,
        ) -> usize,
    >,
    pub read: ::core::option::Option<
        unsafe extern "C" fn(instance: *mut FILE, bp: *mut ::core::raw::c_char, n: usize) -> usize,
    >,
}
#[test]
...
extern "C" {
    pub fn cbor_error_string(error: CborError) -> *const ::core::raw::c_char;
}
pub type cbor_encoder_write = ::core::option::Option<
    unsafe extern "C" fn(
        arg1: *mut cbor_encoder_writer,
        data: *const ::core::raw::c_char,
        len: ::core::raw::c_int,
    ) -> ::core::raw::c_int,
>;
#[repr(C)]
...
pub struct cbor_encoder_writer {
    ...
    pub bytes_written: ::core::raw::c_int,
}
#[test]
...
pub struct cbor_iovec {
    pub iov_base: *mut ::core::raw::c_void,
    pub iov_len: usize,
}
#[test]
...
pub struct CborEncoder {
    ...
    pub writer_arg: *mut ::core::raw::c_void,
    pub added: usize,
    pub flags: ::core::raw::c_int,
}
#[test]
...
pub type cbor_reader_get8 = ::core::option::Option<
    unsafe extern "C" fn(d: *mut cbor_decoder_reader, offset: ::core::raw::c_int) -> u8,
>;
pub type cbor_reader_get16 = ::core::option::Option<
    unsafe extern "C" fn(d: *mut cbor_decoder_reader, offset: ::core::raw::c_int) -> u16,
>;
pub type cbor_reader_get32 = ::core::option::Option<
    unsafe extern "C" fn(d: *mut cbor_decoder_reader, offset: ::core::raw::c_int) -> u32,
>;
pub type cbor_reader_get64 = ::core::option::Option<
    unsafe extern "C" fn(d: *mut cbor_decoder_reader, offset: ::core::raw::c_int) -> u64,
>;
pub type cbor_memcmp = ::core::option::Option<
    unsafe extern "C" fn(
        d: *mut cbor_decoder_reader,
        buf: *mut ::core::raw::c_char,
        offset: ::core::raw::c_int,
        len: usize,
    ) -> usize,
>;
